...
<div class="field field-name-field-ding-event-subscriptions field-label-inline clearfix <?php print $classes; ?>"<?php print $attributes; ?>>
  <div class="field-label"><?php print $label ?></div>
  <div class="field-items">
    <div class="field-item even"><?php print render($link); ?></div>
  </div>
</div>
